...
export const CustomGameDialog: React.FC<CustomGameDialogProps> = ({
    ...
    const handleConfirm = () => {
        ...
        // Recommended maximum is 1/3 of total cells for playability
        const recommendedMax = Math.floor((rowNum * colNum) / 3);
        if (mineNum > recommendedMax) {
            setError(`Warning: ${mineNum} mines might be too difficult!`);
